...
CREATE SEQUENCE waimage.image_id_seq;

CREATE TABLE waimage.image (
                id INTEGER NOT NULL DEFAULT nextval('waimage.image_id_seq'),
...
ALTER SEQUENCE waimage.image_id_seq OWNED BY waimage.image.id;
